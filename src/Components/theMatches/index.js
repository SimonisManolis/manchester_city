...
class TheMatches extends Component {
    ...
    showPlayed = (played) => {
        ...
        this.setState({
            filterMatches: played === 'All' ? this.state.matches : list, //Αν ειναι all να παιρωει την αρχικη λιστα με ολα τα matches αλλιως την νεα λιστα
            playedFilter: played,
            resultFilter: 'All'
        })
    }
    ...
    showResult = (result) =>{
        ...
        this.setState({
            filterMatches: result === 'All' ? this.state.matches : list, //Αν ειναι all να παιρωει την αρχικη λιστα με ολα τα matches αλλιως την νεα λιστα
            playedFilter: 'All',
            resultFilter: result
        })
    }
